...
export default function EnvironmentChart({ data, height = 280, interval = '1h', currentTime }: Props) {
      ...
      tooltip: {
        ...
        formatter: (params: any) => {
          ...
          const lines = validParams.map(
            // eslint-disable-next-line @typescript-eslint/no-explicit-any
            (s: any) => {
              const unit = s.seriesName === 'Irradiance' ? 'W/m²' : '°C';
      ...
      series: [
        {
          ...
          type: 'line',
          yAxisIndex: 0,
          data: data.map(d => [d.timestamp * 1000, d.dataPoints > 0 ? d.avgIrr : null]),
          smooth: smooth,
          showSymbol: false,
          sampling: 'lttb',
