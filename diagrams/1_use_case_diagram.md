# Use Case Diagram — EnergiaMind Platform

> Reconstructed from hand-crafted SVG reference. Layout: Actors on top → Use Cases (circles) below inside System boundary.
