  ...
  fastify.patch<{ Body: Record<string, unknown> }>('/api/v1/config', {
    ...
    schema: {
      body: {
        type: 'object',
        properties: {
          detection_sensitivity: { type: 'number', minimum: 0.1, maximum: 1.0 },
          alert_cooldown_minutes: { type: 'integer', minimum: 1, maximum: 1440 },
          modbus_poll_interval: { type: 'integer', minimum: 1000, maximum: 60000 },
          maintenance_mode: { type: 'boolean' },
          notification_email: { type: 'string', maxLength: 254 },
          auto_acknowledge_info: { type: 'boolean' },
          dashboard_refresh_interval: { type: 'integer', minimum: 1000, maximum: 300000 },
        },
